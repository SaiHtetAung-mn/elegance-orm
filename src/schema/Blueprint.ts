...
import { columnType } from "@schema/constants/ColumnType";
import SchemaGrammar from "@schema/grammars/Grammar";
import { TColumnAttribute } from "@schema/types/TColumnAttribute";
import { TCommandParameter } from "@schema/types/TCommandParameter";
import { TCommandName } from "@schema/types/TCommandName";
import ForeignCommand from "@schema/ForeignCommand";
class Blueprint {
